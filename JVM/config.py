...
data_path = os.path.abspath(os.path.join(root_path, "data/corpus_100000"))
...
def get_data_path(experiment):
    return os.path.abspath(os.path.join(root_path, "data/corpus_%d_%d" % (experiment // 4, experiment % 4)))
