...
sys.path.append('..')
from JVM.config import get_configs, experiment_path, get_data_path
...
class RNNLM_Model():
    def __init__(self, config, experiment_id):
        ...
        self.config = config
        self.data_path = get_data_path(experiment_id)
        self.load_dict()
        self.load_corpus()
    ...
    def load_corpus(self, debug=False):
        self.corpus = Corpus(self.data_path, debug)
    ...
    def load_dict(self):
        self.vocab = Vocab(self.data_path)
